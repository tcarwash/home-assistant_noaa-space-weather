"""Tests for NOAA Space Weather api."""
import asyncio

import aiohttp
from custom_components.noaa_space_weather.api import (
    NoaaSpaceWeatherApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = NoaaSpaceWeatherApiClient("test", "test", async_get_clientsession(hass))
